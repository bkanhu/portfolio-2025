---
title: "Beginners Ubuntu"
publishedAt: "2019-06-23"
summary: "A Beginners Guide To Things To Do After Installing Ubuntu."
---
...
> This blog post was first written in june 2019. Since then, Ubuntu has evolved quite a bit, so some of the tips here may still work, while others might be outdated or no longer applicable.
...
_Additionally, you can also schedule the time for when Night Light sets in._
