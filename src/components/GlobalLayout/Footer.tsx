      ...
      >
        <div className="basis-6/12 space-y-6">
          ...
          <p className="w-full text-woodsmoke-300 md:w-9/12">
            ...
            <Link
              ...
              aria-label="Send an email to B Kanhu"
        ...
        <div className="basis-6/12 space-y-6 py-8">
          ...
          <div className="flex flex-col gap-4">
            <a
              href="mailto:iamkanhuc@gmail.com"
              aria-label="Send email to iamkanhuc@gmail.com"
              className="group relative inline-block text-3xl font-bold text-woodsmoke-100 hover:text-brand-500 md:text-4xl"
            >
              iamkanhuc@gmail.com
              <span className="absolute -bottom-4 left-0 block h-1 w-0 bg-brand-500 transition-all duration-200 group-hover:w-full "></span>
            </a>
          </div>
          ...
          <ul className="flex gap-4">
            {SocialMedia.map((social, index) => (
              <li key={index}>
                <a
                  href={social.link}
                  aria-label={`Link to ${social.name} Profile`}
                  target="_blank"
                  rel="noopener noreferrer"
        ...
        <div className="flex flex-col items-start justify-between gap-y-12 border-b border-woodsmoke-900 pb-8 md:flex-row md:gap-y-0">
          ...
          <div>
            <ul className="flex flex-row gap-x-4">
              <li>
                <Link href="/" aria-label="Home page" className="hover:text-brand-500">
                  Home
                </Link>
              </li>
              <li>
